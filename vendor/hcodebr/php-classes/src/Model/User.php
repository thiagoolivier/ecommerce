...
class User extends Model
{
    ...
    public static function getForgot($email, $inadmin = true)
    {
        ...
        if (count($results) == 0) {
            ...
            TRECHO ANTIGO - SUBSTITUÍDO PELA VERSÃO MANUAL LOGO ABAIXO DESTE COMENTÁRIO
            ...
            */
            ...
            $sql2->select("INSERT INTO tb_userspasswordsrecoveries (iduser, desip) VALUES (:iduser, :desip)", array(
                ":iduser" => $data['iduser'],
                ":desip" => $_SERVER['REMOTE_ADDR']
            ));
